...
- Package - DicSwitcher
- Requiments - Dictionaries plugin (see [here](https://github.com/titoBouzout/Dictionaries))

## Install
Copy the package (DicSwitcher) to `Packages/` (On Linux `~/.config/sublime-text/Packages/`)
...
DicSwitcher adds also a menu to the context menu (right click) to switch between available languages